										...
										Object.keys(Data.days).forEach(
											(day_key) => {
												...
												if(routine_activity.days[day_key]){
													...
													if(DayData.activities[routine_activity_key] && !DayData.activities[routine_activity_key].done){

														delete DayData.activities[routine_activity_key];
													
														UpdateDataByProperty(`days.${day_key}`,DayData);
														return;
													}
												}
											}
